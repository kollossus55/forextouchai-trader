...
input double MaxSpreadPips  = 0;        // Max spread in pips (0 = no check) - set ~10 for Gold
...
int OnInit() {
    ...
    Print("[GoldEA MT5] Gold EA v1.05 | Symbol: ", GoldSymbol, " | MagicNumber: ", MagicNumber, " | FillFlags: ", fillFlags);
    EventSetTimer(1);
...
int OnInit() {
    ...
    Print("[GoldEA] Gold EA v1.04 | Symbol: ", GoldSymbol, " | MagicNumber: ", MagicNumber);
    EventSetTimer(1);
    return INIT_SUCCEEDED;
}
...
void ExecuteSignal(string obj) {
    ...
    int ticket = OrderSend(GoldSymbol, cmd, lot, price, Slippage, finalSL, finalTP, orderComment, MagicNumber, 0, cmd == OP_BUY ? clrGold : clrOrangeRed);
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs font-bold text-emerald-300 bg-emerald-500/20 border border-emerald-500/40 px-2 py-0.5 rounded-full">LATEST: MT5 v1.05 / MT4 v1.04</span>
                    </div>
                    ...
                    <div className="flex gap-2 flex-wrap">
                        <Button
                            onClick={() => download(GOLD_EA_CODE, "GoldForexTouchAI_EA_v104.mq4")}
                            className="bg-amber-500/20 border border-amber-500/40 text-amber-300 hover:bg-amber-500/30 hover:text-amber-100 text-xs"
                            size="sm"
                        >
                            🥇 Download Gold EA MT4 (.mq4) — v1.04
                        </Button>
                        <Button
                            onClick={() => download(GOLD_EA_MT5_CODE, "GoldForexTouchAI_EA_v105.mq5")}
                            ...
                            size="sm"
                        >
                            🥇 Download Gold EA MT5 (.mq5) — v1.05
                        </Button>
                    </div>
                </div>
            </div>
